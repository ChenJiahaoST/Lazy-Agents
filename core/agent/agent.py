...
class CustomReactAgent(ReactAgent):
    #  继承的目的只是为了自定义提示词。。。
     def __init__(self, llm, tools: List[str], custom_prompt: str, max_retries: int = 5, return_trace: bool = False):
        ...
        self._agent = loop(
            FunctionCall(llm, tools, _prompt=custom_prompt, return_trace=return_trace),
